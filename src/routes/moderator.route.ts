...
moderatorRoute.get('/amenity/:id', Controller.AmenityController.getInstance().getAmenity);
moderatorRoute.post('/amenity', Controller.AmenityController.getInstance().addAmenity);
moderatorRoute.put('/amenity/:id', Controller.AmenityController.getInstance().updateAmenity);
moderatorRoute.delete('/amenity/:id', Controller.AmenityController.getInstance().deleteAmenity);

// Room Type
moderatorRoute.get('/room-type', Controller.RoomTypeController.getInstance().getAllRoomType);
moderatorRoute.get('/room-type/:hotel_id', Controller.RoomTypeController.getInstance().getRoomTypeByHotelId);
moderatorRoute.post('/room-type', Controller.RoomTypeController.getInstance().addRoomType);
moderatorRoute.put('/room-type/:id', Controller.RoomTypeController.getInstance().updateRoomType);
moderatorRoute.delete('/room-type/:id', Controller.RoomTypeController.getInstance().deleteRoomType);
...
moderatorRoute.get('/hotel/:hotel_id', Controller.AccountController.getInstance().getModerator);

moderatorRoute.get('/hotel/rating/:hotel_id', Controller.RatingController.getInstance().getAverageRating);
